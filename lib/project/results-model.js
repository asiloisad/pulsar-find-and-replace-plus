...
module.exports = class ResultsModel {
  ...
  async search(findPattern, pathsPattern, replacePattern, options = {}) {
    ...
    const leadingContextLineCount = atom.config.get('find-and-replace-plus.searchContextLineCountBefore')
    const trailingContextLineCount = atom.config.get('find-and-replace-plus.searchContextLineCountAfter')
