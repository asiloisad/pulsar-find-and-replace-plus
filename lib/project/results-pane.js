...
class ResultsPaneView {
  constructor() {
    ...
    this.subscriptions = new CompositeDisposable(
      ...
      atom.config.observe('find-and-replace-plus.searchContextLineCountBefore', this.searchContextLineCountChanged.bind(this)),
      atom.config.observe('find-and-replace-plus.searchContextLineCountAfter', this.searchContextLineCountChanged.bind(this))
    );
  }
  ...
  searchContextLineCountChanged() {
    this.searchContextLineCountBefore = atom.config.get('find-and-replace-plus.searchContextLineCountBefore');
    this.searchContextLineCountAfter = atom.config.get('find-and-replace-plus.searchContextLineCountAfter');
