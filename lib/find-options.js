...
module.exports = class FindOptions {
  constructor(state) {
    ...
    this.useRegex = (left = state.useRegex != null ? state.useRegex : atom.config.get('find-and-replace-plus.useRegex')) != null ? left : false;
    this.caseSensitive = (left1 = state.caseSensitive != null ? state.caseSensitive : atom.config.get('find-and-replace-plus.caseSensitive')) != null ? left1 : false;
    this.wholeWord = (left2 = state.wholeWord != null ? state.wholeWord : atom.config.get('find-and-replace-plus.wholeWord')) != null ? left2 : false;
    this.inCurrentSelection = (left3 = state.inCurrentSelection != null ? state.inCurrentSelection : atom.config.get('find-and-replace-plus.inCurrentSelection')) != null ? left3 : false;
    this.leadingContextLineCount = (left4 = state.leadingContextLineCount != null ? state.leadingContextLineCount : atom.config.get('find-and-replace-plus.leadingContextLineCount')) != null ? left4 : 0;
    this.trailingContextLineCount = (left5 = state.trailingContextLineCount != null ? state.trailingContextLineCount : atom.config.get('find-and-replace-plus.trailingContextLineCount')) != null ? left5 : 0;
  }
